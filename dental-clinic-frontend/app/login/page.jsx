...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // This will automatically catch and display the 403 "Pending Verification" backend error
        ...
        <div className="bg-space_indigo p-8 md:p-12 text-parchment flex flex-col justify-between relative overflow-hidden">
          ...
          <div>
            ...
            <p className="text-sm text-dusty_grape-800 mt-3 leading-relaxed">
              Securely manage your appointments, view clinical notes, and
              coordinate care through our intelligent, role-based platform.
            </p>
          </div>
          ...
          <div className="mt-8 space-y-3 pt-6 border-t border-space_indigo-600/50">
            <div className="flex items-center gap-3 text-xs text-parchment-900">
              <span className="w-5 h-5 rounded-full bg-space_indigo-600/60 flex items-center justify-center text-almond_silk font-bold">
                ✓
              </span>
              <span>Dedicated Dashboards for Patients & Staff</span>
            </div>
            <div className="flex items-center gap-3 text-xs text-parchment-900">
              <span className="w-5 h-5 rounded-full bg-space_indigo-600/60 flex items-center justify-center text-almond_silk font-bold">
                ✓
  ...
  <div>
    <div className="flex justify-between items-center mb-1">
      <label className="block text-xs font-semibold text-space_indigo">
        Password
      </label>
    </div>
    <div className="relative">
      ...
      >
        {showPassword ? (
          <svg
            className="w-4 h-4 text-space_indigo"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <svg
            className="w-4 h-4 text-dusty_grape"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
  ...
  {/* Forgot password link isolated safely on its own line */}
  ...
  <button
    ...
    className="text-xs text-space_indigo hover:underline font-medium bg-transparent border-none cursor-pointer p-0"
  >
    Forgot password?
  </button>
</div>
  ...
  >
    {loading ? "Authenticating..." : "Sign In to Portal →"}
          ...
          <p className="mt-6 text-center text-xs text-dusty_grape">
            Clinic staff without an account?{" "}
            <Link
              href="/register"
